...
ML practitioners and engineers arriving through Field Notes essays — people who encountered a piece on agentic AI or production systems and want to understand who wrote it. They evaluate credibility through the quality of argument, not a resume. They're not evaluating Ahmad for a role; they're deciding whether to keep reading and return.

All three audiences open this on a laptop. The hiring window is 2–5 minutes; the essay reader's window is open-ended but starts thin. The portfolio must earn both.

## Product Purpose

Ahmad Firas Azfar's personal portfolio and technical content platform. Two equal mandates: (1) convince a hiring manager or research collaborator that Ahmad is a researcher and engineer who ships real, specific work in AI, robotics, and autonomous systems; (2) establish Ahmad as a credible voice on production AI through Field Notes — opinionated technical essays that take positions on agentic systems, failure taxonomy, and engineering under uncertainty.

Success on the portfolio side: the visitor reaches the projects or research section, feels the specificity of the results (72.8% zero-shot deployment, R² = 0.982, sub-100ms HITL), and leaves with a concrete picture of what Ahmad actually builds.

Success on the content side: a Field Notes reader finishes an essay with a changed or sharpened view, follows to the portfolio, and returns when the next piece ships.

## Brand Personality

Precise. Deliberate. Credible. Opinionated.

The voice is that of a researcher who has shipped production code and has things to say about it — not a student who has learned frameworks, and not a neutral observer who lists facts. Quiet confidence, no hype. The interface should feel like it was made by the same person who wrote the essays and built the systems. Field Notes takes positions; the portfolio backs them up.
...
6. **Writing is engineering work.** Field Notes essays are not supplemental content — they are primary artifacts of the same quality and intentionality as the projects they sit beside. The essay layout, typography, and diagrams should carry the same precision signal as the project cards. No blog-template defaults.
