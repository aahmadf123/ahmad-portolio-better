...
export const sections: SectionDef[] = [
  ...
  { id: 'skills', n: '03', label: 'Capabilities', color: 'var(--pink)', nav: true },
  { id: 'timeline', n: '04', label: 'Timeline', color: 'var(--purple)', nav: true },
  ...
  { id: 'signals', n: '09', label: 'Signals', color: 'var(--purple)', nav: false },
