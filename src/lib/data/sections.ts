...
export const sections: SectionDef[] = [
  ...
  { id: 'skills', n: '02', label: 'Capabilities', color: '#f472b6', nav: true },
  { id: 'timeline', n: '03', label: 'Timeline', color: '#a78bfa', nav: true },
  { id: 'projects', n: '04', label: 'Work', color: '#f0823c', nav: true },
  { id: 'research', n: '05', label: 'Research', color: '#5b8af5', nav: false },
  { id: 'about', n: '06', label: 'About', color: '#38bdf8', nav: true },
